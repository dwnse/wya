...
function Profile() {
    ...
    if (!member) {
        return <div className="platform-page"><Header /><main className="platform-main"><div className="empty-state"><Icon name="user" size={30} /><p>Este jugador todavía no tiene un perfil competitivo.</p></div></main></div>
    }
